...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x007C, 0x0081, 0x00D3, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x7001, 0x14D4, 0x0001, 0x0C67, 
    /*0x0100*/ 0xADB7, 0x640F, 0x705D, 0x6003, 0x14E1, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7078, 0xFB54, 
    /*0x0120*/ 0x7018, 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C78, 0x14E7, 0x440F, 0x0000, 
    /*0x0140*/ 0x1878, 0x2876, 0x9D2A, 0x9E09, 0x187A, 0x9801, 0x1C7A, 0x187A, 0x2875, 0x9D2A, 0x9E01, 0x0001, 0x04AF, 0x1000, 0x1C7A, 0x1878, 
    /*0x0160*/ 0x2877, 0x9D2A, 0x9E08, 0x187B, 0x9801, 0x1C7B, 0x187B, 0x9A01, 0x9E01, 0x0001, 0x04BD, 0x1000, 0x1C7B, 0x8A01, 0xBE09, 0x0879, 
    /*0x0180*/ 0x8A00, 0xBE05, 0x0001, 0x0C79, 0x086C, 0x8201, 0x0C6C, 0x04D0, 0x0879, 0x8A01, 0xBE05, 0x0000, 0x0C79, 0x086C, 0x8201, 0x0C6C, 
    /*0x01A0*/ 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 0x1465, 
    /*0x01C0*/ 0xADB7, 0xFB0C, 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54, 0xFD47, 0xFB54, 0x1465, 0x4431, 
...
//  cfg         input       output      state       
    0x003010EA, 0x00000000, 0x001010F0, 0x003010F2  // LeakADC
};
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_LEAK_ADC_TASK_ID)) {
        scifReinitIo(1, -1);
        scifReinitIo(8, -1);
    }
} // scifReinitTaskIo
